...
//     const handleToggle = () => {
//         setActiveForm((prevForm) => (prevForm === 'sign-in' ? 'sign-up' : 'sign-in'));
//     };

//     const dev = () => {
//         window.alert("Contact Developer");
//     }
...
//                             <h1 style={{fontWeight:"bold",fontSize:"1.7em",position:"relative",bottom:"1.4em"}}>Sign In</h1>
//                             <span style={{ position: "relative", bottom: "2.4em" }}>or use your email and password</span>
//                             <input type="email" placeholder="Email" />
//                             <input type="password" placeholder="Password" />
//                             <a onClick={dev} style={{cursor:"pointer"}}>Forgot Your Password?</a>
//                             <button>Sign In</button>
//                         </form>
//                     )}
//                 </div>
//                 <div className="toggle-container">
//                     <div className={`toggle ${activeForm === 'sign-up' ? 'active' : ''}`}>
